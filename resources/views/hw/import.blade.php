    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Hardware<small> - import</small></div>

                <div class="panel-body">
					@include('layouts.btn_index', ['url' => '/hw'])
					<hr/>
					@include('layouts.messages')
					@include('layouts.errors')
					
					<form role="form" action="/hw/import" method="post" enctype="multipart/form-data" class="form-inline">
						{!! csrf_field() !!}
