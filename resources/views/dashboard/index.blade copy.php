                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-6">
                                    <table class="table table-bordered table-condensed table-striped table-custom-pad">
                                        ...
                                        <tr>
                                            <td><strong>Total</strong></td>
                                            <td><strong>{{ $system_sum + ($job_count[0]-$system_sum) }}</strong></td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
                                ...
                                <table class="table table-bordered table-condensed table-striped table-custom-pad">
                                    ...
                                    @foreach($workload as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item['cc'] }}</td>
                                            <td>{{ $item['sp'] }}</td>
                                            <td>{{ $item['sa'] + $item['nw'] + $item['st'] + $item['scs'] }}</td>
                                            <td><strong>{{ $item['cc'] + $item['sp'] + $item['sa'] + $item['nw'] + $item['st'] + $item['scs']}}</strong></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
