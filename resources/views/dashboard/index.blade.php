                                        ...
                                        @foreach ($calls as $call)
                                            ...
                                            @else
                                                <tr>
                                                    @if ($call['id'] == 5)
                                                        <td>
                                                            <?php $phase = str_replace('dol', '', Request::get('project')); ?>
                                                            <a
                                                                href="{{ url(
                                                                    'onsite_hw?' .
                                                                        'fromDate=' .
                                                                        explode(' ', $date['startDate'])[0] .
                                                                        '&toDate=' .
                                                                        explode(' ', $date['endDate'])[0] .
                                                                        '&phase=' .
                                                                        $phase,
                                                                ) }}">
                                                                {{ $call['name'] }}
                                    ...
                                    <tbody>
                                        @foreach ($service_type as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item['107'] }}</td>
                                                <td>
                                                    <strong>{{ $item['101'] + $item['102'] + $item['103'] + $item['104'] + $item['105'] + $item['106'] + $item['107'] }}</strong>
                                                </td>
                                                <td>{{ $item['201'] }}</td>
                                                <td>{{ $item['202'] }}</td>
                                                <td>{{ $item['203'] }}</td>
                                                ...
                                                <td>{{ $item['205'] }}</td>
                                                <td>
                                                    <strong>{{ $item['201'] + $item['202'] + $item['203'] + $item['204'] + $item['205'] }}</strong>
                                                </td>
                                                <td>{{ $item['301'] }}</td>
                                                <td>{{ $item['302'] }}</td>
