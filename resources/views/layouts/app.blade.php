                ...
                <ul class="nav navbar-nav">
                    ...
                    @if(Request::user())
                        ...
                        @if(Request::user()->team == 'OBS')
                            ...
                            <li class="@yield('department_active')"><a href="{{ url('/department') }}">REPORT_DEPARTMENT</a></li>
                        {{-- @endif --}}
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                    ONSITE <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu" role="menu">
                                    {{-- @if(Request::user()->team == 'OBS') --}}
                                    <li class="@yield('onsite_active')"><a href="{{ url('/onsite') }}">DETAIL_ONSITE</a></li>
                                    {{-- @endif --}}
                                    <li class="@yield('onsite_al_active')"><a href="{{ url('/onsite_al') }}">ALMOST_SLA</a></li>
                                </ul>
                            </li>
                            <li class="@yield('member_active')"><a href="{{ url('/member') }}">MEMBER</a></li>
                        @endif
                    @endif
