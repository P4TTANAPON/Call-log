    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">PH1 Hardware<small> - import</small></div>

                <div class="panel-body">
					@include('layouts.btn_index', ['url' => '/hw/ph1'])
					<hr/>
					@include('layouts.messages')
					@include('layouts.errors')
					
					<form role="form" action="/hw/ph1/import" method="post" enctype="multipart/form-data" class="form-inline">
						{!! csrf_field() !!}
